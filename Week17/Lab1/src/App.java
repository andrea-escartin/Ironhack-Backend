    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<Building> agencyListings = new ArrayList<>(
            Arrays.asList(
                ...
                new Apartment(60, 160000, "Centelles", 1, false),
                new Apartment(40, 120000, "Centelles", 7, true),
                new Apartment(60, 180000, "La Garriga", 2, false),
                new StorageRoom(20, 60000, "Granollers", false),
                new StorageRoom(20, 50000, "La Garriga", true)
            )
        );
        RealEstateAgency rsAgency = new RealEstateAgency(agencyListings);

        String menu = "\n1 - View all listings" + 
            "\n2- View only a type of listings" +
            "\n3- View listings in a certain area" +
            "\n0 - Exit\n";
        System.out.println("Welcome to our Real Estate Agency:). How can we help you?");
        Integer option;
        String buildingType;
        String buildingArea;
